...
BEGIN { 
    use_ok( 'WWW::Finances::Bovespa2' ); 
    use_ok( 'Moose' );
    use_ok( 'WWW::Mechanize' );
    use_ok( 'XML::XPath' );
}

my $bovespa2 = WWW::Finances::Bovespa2->new();
$bovespa2->find( { codigo => 'PETR3' } );
isa_ok ( $bovespa2, 'WWW::Finances::Bovespa2' );
...
my $bov = WWW::Finances::Bovespa2->new();
$bov->find( { codigo => 'USIM5F' } );
isa_ok( $bov, 'WWW::Finances::Bovespa2' );
